...
export const RecommendedIcon: React.FC = () => (
...
export const CategoryContentPerformanceIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
...
export const CategoryCompetitorAnalysisIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
...
export const CategoryAudienceInsightsIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
...
export const CategoryViralContentIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
...
export const CategoryBrandHealthIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
